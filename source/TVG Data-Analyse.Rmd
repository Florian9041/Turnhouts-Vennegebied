...
data_TVG %>%
  ...
  write.csv22(file = "../exports/SD.csv")
...
data_TVG %>%
  ...
  write.csv2(file = "../exports/ZS105.csv")
...
data_TVG %>%
  ...
  write.csv2(file = "../exports/abs440.csv")
...
data_TVG %>%
  ...
  write.csv2(file = "../exports/Temp.csv")
...
data_TVG %>%
  ...
  write.csv2(file = "../exports/SO4.csv")
...
data_TVG %>%
  ...
  write.csv2(file = "../exports/NO2_N.csv")
