...
data_TVG %>%
  ...
  write.csv(file = "./exports/WD_zhj.csv")
...
data_TVG %>%
  ...
  write.csv(file = "./exports/ZS105.csv")

data_TVG %>%
  filter(AquaComponent %in% "ZS_105") %>%
  group_by(codeplas) %>%
  summarise(ZS105_gem = mean(ResultCalc, na.rm = TRUE)) %>%
  write.csv(file = "./exports/ZS105_gem.csv")
...
data_TVG %>%
  ...
  write.csv(file = "./exports/abs440.csv")
...
data_TVG %>%
  ...
  group_by(codeplas) %>%
  summarise(Ca_max = max(ResultCalc, na.rm = TRUE)) %>%
  write.csv(file = "./exports/Calcium.csv")
...
data_TVG %>%
  ...
  summarise(Cl_max = max(ResultCalc, na.rm = TRUE),
            Cl_90p = quantile(ResultCalc, probs = 0.9)) %>%
  write.csv(file = "./exports/Cl.csv")
...
data_TVG %>%
  ...
  write.csv(file = "./exports/Sal.csv")
```
