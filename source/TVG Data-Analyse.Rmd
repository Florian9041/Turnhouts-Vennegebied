...
create_boxplot <- function(data_TVG, AquaComponent, vline, xlab) {
  ...
  labels_data <- data_TVG %>%
    ...
    mutate(x_pos = Inf)  # Position labels at the right edge of the plot
...
create_boxplot(data_TVG, "Cl", vline_Cl, "Chloride-concentratie (mg/l)")
...
create_boxplot(data_TVG, "EGV25_veld", vline_EGV, "Elektrische geleidbaarheid (µS/cm)")
...
create_boxplot(data_TVG, "T_veld", vline_Temp, "Temperatuur (°C)")
...
create_boxplot(data_TVG, "O2verz", vline_O2v, "Zuurstofverzadiging (%)")
...
create_boxplot_log(data_TVG, "SO4", vline_SO4, "Sulfaat-concentratie (mg/l)")
...
create_boxplot_log(data_TVG %>% filter(seizoen == "zomer"), "TN", vline_TN, "Totale stikstof (log mg N/l)")
...
create_boxplot_log(data_TVG %>% filter(seizoen == "zomer"), "TP", vline_TP, "Totale fosfor (mg P/l)")

# PO4_P
create_boxplot_basic(data_TVG, "PO4_P", "Orthofosfaat (mg P/l)")

# Zwevende stof 105 & 550
create_boxplot_basic(data_TVG, "ZS_105", "Zwevende stof (mg/l 105°)")
create_boxplot_basic(data_TVG, "ZS_550", "Zwevende stof (mg/l 550°)")
...
# NH4_N
create_boxplot_basic(data_TVG, "NH4_N", "NH4_N (mg N/l)")
create_boxplot_basiclog(data_TVG, "NH4_N", "NH4_N (log10 mg N/l)")
...
# NO2_N
create_boxplot_basic(data_TVG, "NO2_N", "NO2_N (mg N/l)")
create_boxplot_basiclog(data_TVG, "NO2_N", "NO2_N (log10 mg N/l)")
...
create_boxplot_log(data_met_N_anorg, "N_anorg", vline_N_anorg, "Anorganische stikstof (log10 mg N/l)")
...
# Assuming data_TVG is your main dataset
plot <- data_TVG %>%
