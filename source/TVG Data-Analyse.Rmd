...
# figuren chloride
for (ID in reeks_2022_2024) {
  data_figuur <- data_TVG %>% filter(meetreeks == "2022-2024")
  figuur <- maak_plot_1var(data_figuur %>% filter(codeplas %in% ID), "Cl") +
  scale_y_continuous(breaks = pretty_breaks(n = 10))
  print(figuur)
  ggsave(plot = figuur,
         filename = paste0("./exports/Chloride/", ID,"_Cl", ".jpg"), width = 1080, height = 720, units = "px", scale = 3)
}
