...
for (ID in locaties) {
  figuur <- maak_plot_1var(data_TVG %>% filter(codeplas %in% ID), "pH_veld" , paste("Zuurtegraad (pH)", ID, "\n"), yas = "Meetwaarde") +
  scale_y_continuous(breaks = pretty_breaks(n = 10))
  print(figuur)
  ggsave(plot = figuur,
...
maak_plot_1var(data_TVG %>% filter(codeplas %in% "ANTRAV0369"), "pH_veld" , paste("Zuurtegraad (pH)", "ANTRAV0369", "\n"), yas = "Meetwaarde") +
  scale_y_continuous(breaks = pretty_breaks(n = 10)) + theme_light()
```
